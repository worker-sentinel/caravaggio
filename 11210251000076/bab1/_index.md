...
Berdasarkan hasil observasi terhadap berbagai Docker image SLiMS yang tersedia secara publik, ditemukan bahwa sebagian besar image belum mendapatkan pembaruan secara berkelanjutan. Beberapa image masih menggunakan *base image*, versi PHP, dan komponen pendukung lainnya yang sudah cukup lama sehingga berpotensi menimbulkan masalah kompatibilitas dengan versi terbaru SLiMS maupun perangkat lunak pendukung yang digunakan saat ini. Selain itu, dokumentasi yang tersedia pada beberapa image masih terbatas sehingga menyulitkan pengguna dalam memahami proses instalasi, konfigurasi, pemeliharaan, dan pembaruan sistem. Kondisi tersebut dapat menjadi kendala bagi perpustakaan yang ingin mengimplementasikan SLiMS secara cepat dan konsisten melalui teknologi containerization.

Hasil observasi juga menunjukkan bahwa sebagian Docker image yang tersedia belum dirancang secara khusus dengan mempertimbangkan efisiensi penggunaan sumber daya dan kemudahan deployment. Beberapa image memiliki ukuran yang relatif besar, memerlukan konfigurasi tambahan setelah container dijalankan, serta belum menerapkan pendekatan optimasi yang dapat meningkatkan efisiensi penggunaan CPU, memori, dan media penyimpanan. Selain itu, belum terdapat standar implementasi yang seragam dalam pengelolaan Docker image SLiMS sehingga setiap image memiliki struktur konfigurasi dan mekanisme deployment yang berbeda. Kondisi tersebut menunjukkan perlunya perancangan Docker image SLiMS yang lebih terstruktur, mudah dipelihara, efisien, dan sesuai dengan kebutuhan implementasi sistem otomasi perpustakaan.
...
6. Hasil penelitian berupa rancangan dan prototipe Docker image yang dapat digunakan sebagai referensi implementasi SLiMS, bukan sebagai produk distribusi resmi dari komunitas pengembang SLiMS.
...
### Penelitian oleh Aprianto dan Wardani (2021)

Penelitian yang dilakukan oleh **Aprianto dan Wardani (2021)** dengan judul **"Penggunaan Metode Prototyping dalam Pengembangan Sistem Informasi Perpustakaan Digital"** bertujuan untuk mengembangkan sistem informasi perpustakaan digital pada SMP Negeri 33 Palembang menggunakan metode prototyping. Penelitian ini dilatarbelakangi oleh masih digunakannya sistem pelayanan perpustakaan secara manual yang kurang efektif, terutama pada masa pandemi Covid-19. Metode prototyping digunakan melalui tahapan identifikasi kebutuhan pengguna, pembuatan prototype, evaluasi bersama pengguna, perbaikan prototype, hingga implementasi sistem. Hasil penelitian menunjukkan bahwa sistem informasi perpustakaan digital yang dikembangkan mampu mempermudah pengelolaan data perpustakaan serta meningkatkan efektivitas layanan kepada pengguna.

Persamaan penelitian tersebut dengan penelitian yang penulis lakukan terletak pada penggunaan **metode prototyping** sebagai metode pengembangan sistem. Kedua penelitian sama-sama mengutamakan keterlibatan pengguna dalam proses pengembangan melalui evaluasi prototype secara bertahap sehingga sistem yang dihasilkan dapat memenuhi kebutuhan pengguna.

Perbedaan penelitian tersebut dengan penelitian yang penulis lakukan adalah penelitian **Aprianto dan Wardani (2021)** berfokus pada pengembangan **sistem informasi perpustakaan digital** sebagai solusi digitalisasi layanan perpustakaan, sedangkan penelitian ini berfokus pada **rancangan Docker image untuk aplikasi SLiMS**. Penelitian ini lebih menitikberatkan pada penyusunan lingkungan deployment menggunakan Docker agar proses instalasi, konfigurasi, dan implementasi aplikasi SLiMS menjadi lebih mudah, konsisten, dan portabel pada berbagai platform.
