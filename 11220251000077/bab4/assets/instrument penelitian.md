...
3. Bisa Anda ceritakan secara menyeluruh bagaimana Podman difungsikan sebagai server dalam ekosistem sistem ini, dan mengapa memilih podman sebagai container utamanya bukan docker atau aplikasi container lain.
4. bisa anda jelaskan infrastruktur apa yang digunakan di podman server dari hardware dan softwarenya dan konfigurasi di dalamnya
...
6. Bisa Anda ceritakan secara menyeluruh bagaimana Forgejo dikonfigurasi dan disesuaikan untuk kebutuhan arsip digital di organisasi ini, termasuk penyesuaian apa saja yang dilakukan dari konfigurasi defaultnya?
...
### 4pilar kearsipan
---
6. Bisa Anda ceritakan bagaimana Tata Naskah Dinas diterjemahkan ke dalam sistem ini secara teknis, termasuk bagaimana standar penciptaan dan format naskah dinas diakomodasi dalam struktur flat file?
...
12. Bisa Anda ceritakan bagaimana Anda memimpin dan mengkoordinasikan tim teknis selama proses deployment berlangsung, termasuk bagaimana pembagian kerja dan pengambilan keputusan teknis bersama dilakukan?
