...
19. ## **Teknik Pengumpulan Data** {#teknik-pengumpulan-data}
    ...
    Dalam penelitian ini peneliti mengumpulkan data melalui wawancara mendalam dengan narasumber yang relevan, seperti arsiparis, pengelola sistem informasi arsip, dan pihak terkait di Organisasi N.
    Wawancara dilakukan untuk memperoleh pemahaman langsung mengenai pengalaman, pandangan, serta kendala yang dihadapi dalam penggunaan protokol informasi berbasis *Flat file*. Metode ini memungkinkan
    peneliti menggali informasi yang tidak tertulis dalam dokumen resmi, termasuk praktik terbaik maupun permasalahan nyata yang terjadi di lapangan.

    Selain itu, peneliti juga melakukan observasi terhadap praktik pengelolaan arsip digital di lingkungan Organisasi N. Observasi ini dilakukan untuk memperoleh data empiris mengenai bagaimana
    protokol *Flat file* digunakan dalam aktivitas sehari-hari, termasuk proses penyimpanan, akses, dan pengamanan arsip. Observasi memungkinkan peneliti melihat secara langsung kesesuaian antara
    teori, kebijakan, dan praktik, serta mengidentifikasi potensi kesenjangan yang dapat mempengaruhi efektivitas protokol.

    Dalam penelitian kualitatif, instrumen utama adalah peneliti sendiri yang berperan sebagai perencana, pelaksana, pengumpul, sekaligus penganalisis data. Peneliti berfungsi sebagai instrumen kunci
    karena keterlibatan langsung memungkinkan penggalian informasi yang lebih mendalam sesuai konteks lapangan (Sugiyono, 2019). Untuk mendukung peran tersebut, penelitian ini juga menggunakan
    instrumen bantu yang disesuaikan dengan teknik pengumpulan data, yaitu pedoman wawancara, lembar observasi, dan dokumen literatur. Pedoman wawancara berisi daftar pertanyaan terbuka yang dirancang
    untuk menggali pengalaman, kendala, dan strategi pengelolaan arsip digital berbasis *Flat file* dari arsiparis dan praktisi. Lembar observasi digunakan untuk mencatat secara sistematis praktik
    nyata pengelolaan arsip digital, meliputi alur kerja penggunaan *Flat file*, mekanisme akses arsip, serta aspek keamanan. Sedangkan dokumen literatur meliputi regulasi kearsipan, jurnal ilmiah,
    dan pedoman teknis yang relevan untuk membandingkan teori dengan praktik yang berlangsung di organisasi studi kasus.

    Selain instrumen tersebut, penelitian ini juga memanfaatkan beberapa peralatan pendukung**.** Peralatan yang digunakan antara lain alat tulis untuk pencatatan lapangan, perekam suara untuk merekam
    hasil wawancara, kamera atau ponsel untuk mendokumentasikan kegiatan observasi, serta komputer atau laptop untuk menyusun, mengolah, dan menganalisis data. Penggunaan instrumen dan peralatan ini
